...
export const materialDatabase: MaterialData[] = [
  ...
  { name: "PEI (Ultem)", category: "polymer", elasticModulus: 3.3, yieldStrength: 85, shearStrength: 50, compressiveYield: 152, poissonRatio: 0.36, notes: "High-temp polymer — Sabic Ultem 1000" },
  // 3D printed polymers
