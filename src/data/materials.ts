...
export const materialDatabase: MaterialData[] = [
  // Metals
  { name: "Aluminum 6061-T6", category: "metal", elasticModulus: 69, yieldStrength: 276, shearStrength: 207, poissonRatio: 0.33, notes: "Machined, general purpose" },
  { name: "Aluminum 7075-T6", category: "metal", elasticModulus: 72, yieldStrength: 503, shearStrength: 331, poissonRatio: 0.33, notes: "Machined, high strength" },
  ...
  { name: "Stainless 304 (1.4301)", category: "metal", elasticModulus: 193, yieldStrength: 215, shearStrength: 170, poissonRatio: 0.29, notes: "Austenitic stainless" },
  { name: "Stainless 303 (1.4305)", category: "metal", elasticModulus: 193, yieldStrength: 240, shearStrength: 180, poissonRatio: 0.29, notes: "Free-machining stainless" },
  ...
  { name: "PEEK (30% CF)", category: "composite", elasticModulus: 12, yieldStrength: 210, shearStrength: 100, poissonRatio: 0.38, notes: "Carbon fiber filled" },
  { name: "POM (Delrin)", category: "polymer", elasticModulus: 2.9, yieldStrength: 65, shearStrength: 40, poissonRatio: 0.35, notes: "Acetal" },
  { name: "PEI (Ultem)", category: "polymer", elasticModulus: 3.3, yieldStrength: 85, shearStrength: 50, poissonRatio: 0.36, notes: "High-temp polymer" },
  // 3D printed polymers
  ...
  { name: "PA6 GF30", category: "composite", elasticModulus: 9.5, yieldStrength: 185, shearStrength: 95, poissonRatio: 0.35, notes: "30% glass-filled polyamide 6" },
];
